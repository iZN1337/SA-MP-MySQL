...
cell AMX_NATIVE_CALL Native::cache_get_field_name(AMX* amx, cell* params)
{
	...
	amx_SetCString(amx, params[2], field_name == nullptr ? "NULL" : field_name, params[4]);
	return 1;
}
...
cell AMX_NATIVE_CALL Native::cache_get_row(AMX* amx, cell* params)
{
	...
	amx_SetCString(amx, params[3], row_data == nullptr ? "NULL" : row_data, max_len);
	return 1;
}
...
cell AMX_NATIVE_CALL Native::cache_get_field_content(AMX* amx, cell* params)
{
	...
	amx_SetCString(amx, params[3], field_data == nullptr ? "NULL" : field_data, max_len);
	return 1;
}
